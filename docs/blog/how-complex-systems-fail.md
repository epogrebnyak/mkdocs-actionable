...
Ричард Кук также написал 18 тезисов о надежности информационных систем, такие как:

> Чтобы обеспечить работу без сбоев, нужен обыт работы со сбоями.
...
<!--
1. Чтобы обеспечить работу без сбоев, нужен обыт работы со сбоями.
-->
